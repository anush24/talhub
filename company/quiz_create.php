...
<table><tr><td><input class="btn" type="submit" name="create" value="Create Quiz"/></td><td></td><td><input class="btn" type="submit" name="delete" value="Delete Selected Questions"/></td><td></td><td><input class="btn" type="submit" name="addq" value="Add New Question"/></td></tr></table>
</form>
</div>
</div>
